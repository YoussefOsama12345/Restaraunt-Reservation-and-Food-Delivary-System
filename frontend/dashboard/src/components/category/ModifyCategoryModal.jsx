...
const ModifyCategoryModal = ({ isOpen, onClose, onSubmit, category }) => {
  ...
  useEffect(() => {
    if (category) {
      console.log('Setting initial form data:', category); // Debug log
      setFormData({
        name: category.name || '',
        category: category.category || '',
        stock: category.stock?.toString() || '',
        sales: category.sales?.toString() || '',
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      console.log('Modified category:', modifiedCategory); // Debug log
      onSubmit(modifiedCategory);
    }
  };
